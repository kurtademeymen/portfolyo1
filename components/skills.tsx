...
const skills = [
  ...
  },
  {
    ...
    level: "Temel",
    icon: Gamepad2,
    description: "Oyun geliştirme ve 3D projeler",
  ...
  },
  {
    ...
    level: "Orta",
    icon: Film,
    description: "Motion graphics ve video düzenleme",
  ...
  },
  {
    ...
    level: "Orta",
    icon: Music,
    description: "Müzik prodüksiyon ve ses tasarımı",
  ...
  },
  {
    ...
    level: "Orta",
    icon: Cpu,
    description: "Arduino, sensörler ve proje geliştirme",
